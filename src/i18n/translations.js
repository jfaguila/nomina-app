export const translations = {
  es: {
    ...
    cookies: {
      ...
      text2: 'cookies de Google Ads y del píxel de Meta para medir nuestras campañas. Nunca vendemos tus datos y tu nómina no se guarda.',
      more: 'Más info',
      reject: 'Rechazar',
      accept: 'Aceptar',
    },
  ...
  en: {
    ...
    cookies: {
      ...
      text2: 'Google Ads and Meta pixel cookies to measure our campaigns. We never sell your data and your payslip is never stored.',
      more: 'More info',
      reject: 'Reject',
      accept: 'Accept',
    },
