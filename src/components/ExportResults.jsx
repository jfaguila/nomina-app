...
const ExportResults = ({ results, fileName = 'nomina-analisis' }) => {
    ...
    const exportToCSV = () => {
        let csvContent = "Concepto,Tu Nómina (€),Debería Ser (€),Diferencia (€),Estado\n";
        ...
        if (results.details) {
            ...
            if (results.details.antiguedad) {
                ...
                csvContent += `Antigüedad,${ant.real || 0},${ant.teorico || 0},${ant.diferencia || 0},${ant.estado}\n`;
            }
        ...
        // Resumen general
        csvContent += `\nResumen\n`;
        csvContent += `Estado General,${results.isValid ? 'VÁLIDO' : 'CON ERRORES'},,,\n`;
    ...
    const exportToPDF = async () => {
        ...
        <body>
            ...
            <div class="status ${results.isValid ? 'valid' : 'invalid'}">
                <h2>${results.isValid ? '✅ Nómina Correcta' : '❌ Nómina con Errores'}</h2>
                <p>${results.isValid ? 'Tu nómina cumple con el convenio aplicable' : 'Se han detectado inconsistencias'}</p>
            </div>
            ...
            <div class="footer">
                <p>Reporte generado por Verificador de Nóminas</p>
                <p>Este reporte es informativo y no constituye asesoramiento legal</p>
            </div>
        </body>
        </html>`;
        
        // Usar printToPDF del navegador (si está disponible)
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-xl">
                <div className="flex items-start space-x-2">
                    ...
                    <div className="text-left">
                        <p className="text-sm font-medium text-blue-800">Formatos de exportación</p>
